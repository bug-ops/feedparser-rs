...
- Updated `h2` to 0.4.16, fixing [RUSTSEC-2026-0258](https://rustsec.org/advisories/RUSTSEC-2026-0258): unbounded empty DATA frames could be queued without limit if streams were not actively drained, leading to unbounded memory usage or a panic on length overflow. Pulled in transitively via `hyper`/`reqwest` (HTTP fetcher); low severity, no code changes required (#495).
...
[Unreleased]: https://github.com/bug-ops/feedparser-rs/compare/v0.7.0...HEAD
[0.7.0]: https://github.com/bug-ops/feedparser-rs/compare/v0.6.0...v0.7.0
